---
title: 'Payfit Reduces Feature Deployment from 5 Days to 2 Hours with Nx Monorepo Revival'
slug: payfit-success-story
authors: [Juri Strumpflohner]
tags: ['customer story']
description: Discover how Payfit's platform team transformed their development velocity by reviving their Nx monorepo and leveraging Nx Cloud for CI optimization.
youtubeUrl: https://www.youtube.com/watch?v=VIDEO_ID_HERE
cover_image: /blog/images/articles/payfit-story-bg.jpg
metrics:
  - value: '5 days→2 hours'
    label: 'feature deployment time'
  - value: '4x faster'
    label: 'coding speed improvement'
  - value: '4 engineers'
...
### Monorepo Revival Strategy

The platform team focused on making the monorepo a compelling choice rather than a mandate:
...
One of the most significant improvements came from adopting Nx Cloud to handle CI optimization:
...
This shift from manual CI optimization to automated intelligence freed the platform team to focus on higher-value work while ensuring optimal performance.

{% testimonial
    name="Nicolas Beaussart"
    title="Staff Engineer, Payfit"
    image="/documentation/blog/images/articles/nicolas-beaussart.avif" %}
The main thing with Nx Cloud is that we don't have to think about that—just here is my task, deal with it. We just offload this whole complexity of keeping velocity at scale in a large monorepo thanks to Nx Cloud.
{% /testimonial %}
...
{% call-to-action title="Ready to transform your development velocity?" url="/enterprise" icon="nxcloud" description="Learn more about Nx Enterprise and see how we can help your team achieve similar results." /%}
