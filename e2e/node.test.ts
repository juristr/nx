...
forEachCli(currentCLIName => {
  ...
  describe('Node Applications', () => {
    ...
    describe('Node Libraries', () => {
      beforeAll(() => {
        // force a new project to avoid collissions with the npmScope that has bene altered before
        newProject();
      });
      ...
      describe('with dependencies', () => {
        ...
        beforeEach(() => {
          ...
          runCLI(`generate @nrwl/node:lib ${childChildLib} --publishable=true`);
          runCLI(
            `generate @nrwl/node:lib ${childLibShared} --publishable=true`
          );
