  ...
  return (
    <div className="flex no-prose">
      <a
        ...
        className="flex items-center no-underline hover:underline space-x-2 border-transparent"
      >
        <div className="flex items-center justify-between pl-2 pr-2 space-x-2 border rounded-md border-gray-200 hover:border-gray-400 dark:border-gray-700">
          {youtubeIcon}
